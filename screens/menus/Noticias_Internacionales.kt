...
@Composable
fun Noticias_Internacionales(innerPadding: PaddingValues) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
fun ImageCarousel1(images: List<Int>, modifier: Modifier = Modifier) {
...
@OptIn(ExperimentalPagerApi::class)
@Composable
fun NoticiasCarousel(noticias: List<Int>) {
    val pagerState = rememberPagerState()
    val scope = rememberCoroutineScope()
