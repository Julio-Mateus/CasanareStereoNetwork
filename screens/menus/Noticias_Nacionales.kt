...
@Composable
fun Noticias_Nacionales(innerPadding: PaddingValues) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
fun ImageCarousel2(images: List<Int>, modifier: Modifier = Modifier) {
...
@OptIn(ExperimentalPagerApi::class)
@Composable
fun NoticiasCarousel1(noticias: List<Int>) {
    val pagerState = rememberPagerState()
    val scope = rememberCoroutineScope()
